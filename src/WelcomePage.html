...
 
<p style="text-align: center;">Password:&nbsp;<input maxlength="10" name="passwordText" type="text" /></p>
 
<p style="text-align: center;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<input name="LoginButton" type="button" value="Login" /></p>
 
<p style="text-align: center;">Please use your login information provided to you so you can enter and update your information.</p>
 
